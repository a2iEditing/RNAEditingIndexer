...
echo "GeneExpressions = ${HUMAN_GENES_EXPRESSION_DIR}/${HG38_GENES_EXPRESSION_FILE}" >> ${DBS_PATHS_INI}
echo "" >> ${DBS_PATHS_INI}
...
echo "GeneExpressions = ${HUMAN_GENES_EXPRESSION_DIR}/${HG19_GENES_EXPRESSION_FILE}" >> ${DBS_PATHS_INI}
echo "" >> ${DBS_PATHS_INI}
